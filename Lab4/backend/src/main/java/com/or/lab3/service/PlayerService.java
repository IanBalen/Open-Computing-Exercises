...
import com.or.lab3.domain.*;
import com.or.lab3.repository.PlayerRepository;
import com.or.lab3.repository.TeamRepository;
...
public class PlayerService {
    ...
    public ResponseEntity<String> addPlayer(AddPlayerDTO request) {
        Team team = teamRepository.findById(Integer.valueOf(request.getTeamId())).orElseThrow();
        ...
        return ResponseEntity.ok("Player added with " + player.getId());
    }
